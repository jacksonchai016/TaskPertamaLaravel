...
(1, '2022-11-20 08:44:39', '2022-11-20 08:44:39', 'ATK'),
(2, '2022-11-20 08:44:46', '2022-11-20 08:44:46', 'Pakaian'),
(3, '2022-11-20 08:44:51', '2022-11-20 08:44:51', 'Elektronik');
...
(5, '2022_11_12_080826_create_categories_table', 1),
(6, '2022_11_12_084411_create_user_roles_table', 1),
(7, '2022_11_12_085043_create_reservation_statuses_table', 1),
...
--
-- Table structure for table `missing_items_statuses`
--

CREATE TABLE `missing_items_statuses` (
  `id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
--
-- Indexes for table `missing_items_statuses`
--

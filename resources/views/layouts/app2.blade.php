...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src='{{ asset("AdminLTE/dist/img/J_Logo.jpg") }}' alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Jackson</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src='{{ asset("AdminLTE/dist/img/gambar_hacker.jpg") }}' class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a class="d-block">03081200032</a>
        </div>
      </div>

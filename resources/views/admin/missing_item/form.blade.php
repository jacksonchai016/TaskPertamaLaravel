...
<div class="form-group {{ $errors->has('missing_item_status_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="missing_item_status_id" type="number" id="missing_item_status_id" value="{{ isset($missing_item->missing_item_status_id) ? $missing_item->missing_item_status_id : ''}}" >

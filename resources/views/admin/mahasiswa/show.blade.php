                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nim Mahasiswa </th><td> {{ $mahasiswa->nim_mahasiswa }} </td></tr><tr><th> Nama Mahasiswa </th><td> {{ $mahasiswa->nama_mahasiswa }} </td></tr><tr><th> Alamat Rumah Mahasiswa </th><td> {{ $mahasiswa->alamat_rumah_mahasiswa }} </td></tr>
                                </tbody>
                            </table>
                        </div>
